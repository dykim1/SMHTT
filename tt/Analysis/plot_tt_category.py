...
categories=["tt_0jet","ttOS_vbf","ttOS_vh"]
...
for i in range (0,ncat):
   ...
   SMHWH=file.Get(categories[i]).Get("WH")
...
#   legende.AddEntry(SMH,"SM Higgs(125)x5.0","l")
   legende.AddEntry(SMHVBF,"VBF Higgs(125)x5.0","l")
   legende.AddEntry(SMHggH,"ggH Higgs(125)x5.0","l")
   ...
   h1.Divide(hwoE)
   h3.Divide(hwoE)
   h1.GetXaxis().SetTitle("Dbkg")#M_{jj} [GeV]")#"M_{#tau#tau} [GeV]")
